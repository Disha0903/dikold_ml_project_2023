...
setwd('C:/Users/User/Desktop/project_ml_team29/data/curr_env')

#Shape files of Norway and Sweden
no_sh <- shapefile("C:/Users/User/Desktop/project_ml_team29/data/NOR_adm/NOR_adm0.shp")
sw_sh <- shapefile("C:/Users/User/Desktop/project_ml_team29/data/SWE_adm/SWE_adm0.shp")
sh <- rbind(no_sh, sw_sh, makeUniqueIDs = TRUE)
all_rasters <- list.files(path = "C:/Users/User/Desktop/project_ml_team29/data/curr_env", pattern='.asc', 
...
#Species data
gen_cam_occ <- read.csv('C:/Users/User/Desktop/project_ml_team29/data/species_data/curr_occ.csv')
gen_cam <- read.csv('C:/Users/User/Desktop/project_ml_team29/data/species_data/curr_abs.csv')
...
## PAST DATA
df_abs_past <- read.csv('C:/Users/User/Desktop/project_ml_team29/data/species_data/past_abs.csv')
df_occ_past <- read.csv("C:/Users/User/Desktop/project_ml_team29/data/species_data/past_occ.csv")



setwd("C:/Users/User/Desktop/project_ml_team29/data/past_env")
all_rasters_test <- list.files(path = "C:/Users/User/Desktop/project_ml_team29/data/past_env", pattern='.asc', 
                                all.files=TRUE, full.names=FALSE)
...
##FUTURE data
setwd("C:/Users/User/Desktop/project_ml_team29/data/fut_env")
all_rasters_fut <- list.files(path = "C:/Users/User/Desktop/project_ml_team29/data/fut_env", pattern='.asc', 
                              all.files=TRUE, full.names=FALSE)
...
spatial_cv <- function(pa_data, cropped_env, 
                       ...
                       cropped_env_fut){
  sizes <- c(20000, 200000, 407950,700000)
...
plot_prediction <- function(bio_curr_df_lst){
  ...
  bio_spBlock20 <- as.data.frame(bio_curr_df_lst[1:3])
  bio_spBlock200 <- as.data.frame(bio_curr_df_lst[4:6])
  bio_spBlock400 <- as.data.frame(bio_curr_df_lst[7:9])
  bio_spBlock700 <- as.data.frame(bio_curr_df_lst[10:12])
  
  my_colors_3 <- c( "#008fbf", "#47b0df",
                    "#dae695", '#e6ae95', 
                    "#df7b7b", "#a00000" )
  
  lst_curr_map <- list(bio_spBlock20=bio_spBlock20,bio_spBlock200=bio_spBlock200,bio_spBlock400=bio_spBlock400,bio_spBlock700=bio_spBlock700)
  ID <- names(lst_curr_map)
  ID_curr <- c(bio_spBlock20='spBlock20', 
               bio_spBlock200='spBlock200', 
               bio_spBlock400='spBlock400', 
               bio_spBlock700='spBlock700')
...
png("C:/Users/User/Desktop/project_ml_team29/figures/spatial_cv_map_fut.png")
print(fut_plot)
dev.off()

save_prediction <- function(df_pred){
  spBlock20 <- as.data.frame(df_pred[1:3])
  spBlock200 <- as.data.frame(df_pred[4:6])
  spBlock400 <- as.data.frame(df_pred[7:9])
  spBlock700 <- as.data.frame(df_pred[10:12])
  
  data_names <- c("spBlock20", "spBlock200", "spBlock400", 'spBlock700')  
  
  for(i in 1:length(data_names)) {                              # Head of for-loop
    write.csv2(get(data_names[i]),                              # Write CSV files to folder
               paste0("C:/Users/User/Desktop/project_ml_team29/results/",
                      data_names[i],
                      ".csv"),
               row.names = FALSE)
  }
...
## To check ROC AUC scores separately you can run this code, but
## I plotted all curves using matplotlib, check ipynb file
