## Fucntion for B-LOO CV. It requires a lot of time to run ~ 5-6 hours
...
png("C:/Users/User/Desktop/project_ml_team29/figures/buff_cv_map_curr.png")
print(cur_plot)
dev.off()
...
##Save map of future prediction
png("C:/Users/User/Desktop/project_ml_team29/figures/buff_cv_map_past.png")
print(past_plot)
dev.off()
...
##Save map of future prediction
png("C:/Users/User/Desktop/project_ml_team29/figures/buff_cv_map_fut.png")
print(fut_plot)
dev.off()
